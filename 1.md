...
|**selectValue**  | 绑定的值 | Object | 例：{dizhi:''} |  {} |
...
| 参数  | 说明 | 类型 | 可选值 |默认值 |
| :-----| ----: | :----: | :----: | :----: |
|**title**  | Dialog标题 | String | - | “序号”	|
|**show**  | 弹窗隐藏显示 | String | - | “id”	|
|**componentSelect**  | 组件名 | String | - | “200”|
|**top**  | 弹窗top | String | - | “200”|
|**width**  | 弹窗宽 | String | - | “200”|
|**height**  | 弹窗高 | String | - | “200”|
|**isShowFooter**  | 底部按钮是否隐藏 | String | - | “200”|
|**footerTitle**  | 底部按钮 | String | - | “200”|
|**parentFun**  | 父组件方法 | String | - | “200”|
|**childrenFun**  | 子组件方法 | String | - | “200”|
